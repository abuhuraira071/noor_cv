      ...
      <div className="relative mx-auto max-w-[1160px] px-4 sm:px-6">
        <div className="grid gap-8 lg:gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <motion.div style={{ opacity }} className="relative min-w-0">
            ...
            {/* Name with letter-by-letter reveal - MD/NOOR split, RASHEDUZZAMAN as solid gradient for visibility */}
            <div className={`mt-5 sm:mt-6 font-display text-[32px] xs:text-[36px] sm:text-[48px] md:text-[56px] lg:text-[62px] font-semibold leading-[0.9] tracking-[-0.04em] ${isLight ? "text-[#1A1E1C]" : "text-[#E8E6E1]"}`}>
              ...
              <motion.span
                ...
                className="inline-block bg-gradient-to-r from-[#8B5E34] via-[#C2A27A] to-[#5C4033] bg-clip-text text-transparent"
              >
                RASHEDUZZAMAN
              </motion.span>
              <br />
